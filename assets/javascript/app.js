...
// "https://api.openweathermap.org/data/2.5/weather?zip=78728,us&units=imperial&appid=11d3ec545af75db253dcba87baa3df79";
...
$.ajax({
  ...
  .then(function (response) {
    ...
    $(".card-stacked, .modalTest1").html("<p> " + response.name + "</p>");
    // weather info in card-content
    $(".card-content, .modalTest2").html("<p><h4>" + theWeather + ' \xB0F' + "</h4></p>" + "<p><h7> " + now + "</h7></p>");


    // for modal - this is optional! activities ln 129
      // city  name in card-title
      $(".modalTest1").html("<p><h3> " + response.name + "</h3></p>");
      // weather info in card-content
      $(" .modalTest2").html("<p><h4>" + theWeather + ' \xB0F' + "</h4></p>" + "<p><h7> " + theClouds + "</h7></p>");
